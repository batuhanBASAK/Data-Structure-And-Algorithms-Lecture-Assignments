...
public class Account {
     ...
     */
    public Account(int userId, String fullName,String location, String birthday, LinkedList<Post> posts, LinkedList<Message> messages) {
        this.userId = userId;
        ...
        this.inboxMessages = new LinkedList<>();
        this.outboxMessages = new LinkedList<>();
        if (messages != null) {
    ...
    public void viewPost(Account theAccount) {
        ...
        LinkedList<Post> tmpPosts = theAccount.getPosts();
