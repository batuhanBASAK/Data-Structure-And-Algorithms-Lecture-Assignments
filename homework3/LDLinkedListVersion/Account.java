...
public class Account {
    ...
    /** Inbox messages */
    private LDLinkedList<Message> inboxMessages;
    /** Outbox messages */
    private LDLinkedList<Message> outboxMessages;
    ...
    /** Action history */
    private LDLinkedList<String> actionHistory;
     ...
     */
    public Account(int userId, String fullName,String location, String birthday, LDLinkedList<Post> posts, LDLinkedList<Message> messages) {
        this.userId = userId;
        ...
        this.inboxMessages = new LDLinkedList<>();
        this.outboxMessages = new LDLinkedList<>();
        if (messages != null) {
        ...
        this.actionHistory = new LDLinkedList<>();
    ...
    public void viewPost(Account theAccount) {
        ...
        LDLinkedList<Post> tmpPosts = theAccount.getPosts();
    ...
    public boolean isBlocked(Account theAccount) {
        if (theAccount == blockedAccounts.getRemoval()){
            return false;
        }
